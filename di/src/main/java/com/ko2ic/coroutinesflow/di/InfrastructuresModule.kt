...
class InfrastructuresModule {
    ...
    @Provides
    @Singleton
    fun provideHttpClientLocator(): HttpClientLocator =
        HttpClientDefault()

    @Provides
    @Singleton
    @HttpLocate(HttpLocateType.Github)
    fun provideLocatorError(): HttpClientLocator =
        HttpClientErrorMock()
    ...
    fun provideCommentRepository(
        ...
        CommentRepositoryImpl(caller, locator, errorLocator)
    ...
    fun provideKtorCommentRepository(
        ...
        KtorCommentRepositoryImpl(caller, client)
